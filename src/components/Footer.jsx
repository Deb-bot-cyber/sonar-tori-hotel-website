    ...
    <footer className="bg-dark-bg border-t border-primary/20 pt-20">
      <div className="w-full px-[60px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-16">
        <div className="space-y-6">
          <div className="font-heading text-3xl font-bold tracking-wider text-white">
            Sonar <span className="text-primary italic">Tori</span>
          </div>
          ...
          <div className="flex gap-4 pt-4">
            {['FB', 'IG', 'TW', 'IN'].map(social => (
              <a 
                key={social} 
                href="#" 
                className="w-10 h-10 border border-white/20 rounded-none flex items-center justify-center text-xs font-bold text-white hover:bg-primary hover:border-primary hover:text-dark-bg transition-all duration-300"
              >
                {social}
              </a>
            ))}
